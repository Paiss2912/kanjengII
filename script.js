const CONFIG = {
    mainQuestion: "Kanjeng Dhini bukan?",
    subQuestion: "kakak umban cantik itu kan ya? ",
    yesButton: "YES",
    noButton: "NO",
    noEscapeTexts: ["hehe", "boong pertama diumur 23 btw", "yaudala anggap yes aja yaa"],
    confirmTitle: "PIBESDAYYYY KAKAKKK",
    confirmText: "untuk yg paling cantik wangi baik kuatt hebat penyabar manis dan yg pasti masakannya wow bangettt ialah",
    badgeText: "DHINI AULIA PUTRI ",
    nextButton: "lanjstuy ",
    repeatButton: "mau nyoba ulang? ",
    flowerTitle: "ha ini kadonya",
    takeBouquetButton: "buka bubble wrapnya coba ",
    bouquetMessage: "YEAYYYYYY",
    nextFlowerButton: "lanjtsuyy ",
    collageTitle: "Another Year Another Storyy",
    collageSubtitle: "Keep being to be a good person, beauty, kind, and patient of energy to be cheerful girl kakak💐💐💐",
    nextCollageButton: "satu lagi… ",
    finalTitle: "💐SELAMATT PIBESDAYY DHINAUPUT💐",
    finalMessage: `To my most tender prayer, Happy Birthday. I hope the universe treats you kindly as your heart treats the world. May you always be happy as the prayers i whisper for u, and just stay as you are yaaw🪐🫶🏻`,
    restartButton: "mau nyoba lagi kakak? ",
    copyButton: "udahan",
    copySuccess: "beklah bole close"
};
